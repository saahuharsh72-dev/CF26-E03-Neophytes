...
- **Recommended (local server):**
  ...
  ```
- **In VS Code:** install the **Live Server** extension, open `index.html`,
  then click **Go Live** (bottom-right).

> Tip: setting a budget, ticking interventions, and pressing **▶ Run
> Simulation** is all you need to see the engine work.

## Host it free on GitHub Pages (live on the internet)

1. Push this folder to a GitHub repository (the repo must be **Public** for
   free hosting).
2. In the repo: **Settings → Pages → Build and deployment → Source:
   "Deploy from a branch"**, then choose branch **`main`** and folder
   **`/ (root)`**, and click **Save**.
3. Wait ~1–2 minutes. Your app is live at:
   `https://<your-username>.github.io/<repo>/`

Because the app uses relative file paths and needs no build, it works on
